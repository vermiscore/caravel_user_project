...
assign io_oeb[6:0] = 7'b0;
 ...
 wire one_;
 wire zero_;
  sky130_fd_sc_hd__conb_1 TIE_ZERO_zero_ (.VGND(vssd1), .VNB(vssd1), .VPB(vccd1), .VPWR(vccd1), .LO(zero_));
  sky130_fd_sc_hd__conb_1 TIE_ONE_one_ (.VGND(vssd1), .VNB(vssd1), .VPB(vccd1), .VPWR(vccd1), .HI(one_));
