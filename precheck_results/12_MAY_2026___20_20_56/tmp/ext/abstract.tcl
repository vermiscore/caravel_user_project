...
puts "Abstracting /tmp/tmpldfikc4p/repo/gds/user_project_wrapper.gds"
...
W7_sky130_fd_sc_hd__tapvpwrvgnd_1 } { ;# Set abstract cells and delete all their subcell instances.
	load $cell
