...
UA_sky130_fd_sc_hd__tapvpwrvgnd_1
ucb_top } { ;# Load abstract cells
	if { [file exists /tmp/tmpj3_gmuiu/repo/precheck_results/13_MAY_2026___12_56_51/tmp/ext/$cell.lef] } {
		puts "Using abstracted $cell"
		lef read /tmp/tmpj3_gmuiu/repo/precheck_results/13_MAY_2026___12_56_51/tmp/ext/$cell.lef
	}
}
...
puts "\nExtracting /tmp/tmpj3_gmuiu/repo/gds/user_project_wrapper.gds"
gds read /tmp/tmpj3_gmuiu/repo/gds/user_project_wrapper.gds
cd /tmp/tmpj3_gmuiu/repo/precheck_results/13_MAY_2026___12_56_51/tmp/ext
