...
sky130_fd_sc_hd__tapvpwrvgnd_1 } { ;# Load abstract cells
	if { [file exists /tmp/tmpq2k5l4bw/repo/precheck_results/13_MAY_2026___13_45_20/tmp/ext/$cell.lef] } {
		puts "Using abstracted $cell"
		lef read /tmp/tmpq2k5l4bw/repo/precheck_results/13_MAY_2026___13_45_20/tmp/ext/$cell.lef
	}
}
...
puts "\nExtracting /tmp/tmpq2k5l4bw/repo/gds/user_project_wrapper.gds"
gds read /tmp/tmpq2k5l4bw/repo/gds/user_project_wrapper.gds
cd /tmp/tmpq2k5l4bw/repo/precheck_results/13_MAY_2026___13_45_20/tmp/ext
...
foreach cell { sky130_fd_sc_hd__fill_1
sky130_fd_sc_hd__fill_2
sky130_fd_sc_hd__tapvpwrvgnd_1 } { ;# Set abstract cells
	load $cell
