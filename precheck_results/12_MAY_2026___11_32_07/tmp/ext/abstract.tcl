...
puts "Abstracting /tmp/tmpdjsgq6t1/repo/gds/user_project_wrapper.gds"
...
M4_sky130_fd_sc_hd__tapvpwrvgnd_1 } { ;# Set abstract cells and delete all their subcell instances.
	load $cell
