...
foreach cell { PR_sky130_fd_sc_hd__fill_1
PR_sky130_fd_sc_hd__fill_2
PR_sky130_fd_sc_hd__fill_4
PR_sky130_fd_sc_hd__fill_8
PR_sky130_fd_sc_hd__tapvpwrvgnd_1 } { ;# Load abstract cells
	if { [file exists /tmp/tmpeemsctja/repo/precheck_results/12_MAY_2026___10_39_15/tmp/ext/$cell.lef] } {
		puts "Using abstracted $cell"
		lef read /tmp/tmpeemsctja/repo/precheck_results/12_MAY_2026___10_39_15/tmp/ext/$cell.lef
	}
}
...
puts "\nExtracting /tmp/tmpeemsctja/repo/gds/user_project_wrapper.gds"
gds read /tmp/tmpeemsctja/repo/gds/user_project_wrapper.gds
cd /tmp/tmpeemsctja/repo/precheck_results/12_MAY_2026___10_39_15/tmp/ext
...
PR_sky130_fd_sc_hd__fill_4
PR_sky130_fd_sc_hd__fill_8
PR_sky130_fd_sc_hd__tapvpwrvgnd_1 } { ;# Set abstract cells
	load $cell
