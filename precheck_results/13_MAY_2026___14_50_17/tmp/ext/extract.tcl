...
foreach cell { UA_sky130_fd_sc_hd__fill_1
UA_sky130_fd_sc_hd__fill_2
UA_sky130_fd_sc_hd__tapvpwrvgnd_1 } { ;# Load abstract cells
	if { [file exists /tmp/tmpjktlz_pc/repo/precheck_results/13_MAY_2026___14_50_17/tmp/ext/$cell.lef] } {
		puts "Using abstracted $cell"
		lef read /tmp/tmpjktlz_pc/repo/precheck_results/13_MAY_2026___14_50_17/tmp/ext/$cell.lef
	}
}
...
puts "\nExtracting /tmp/tmpjktlz_pc/repo/gds/user_project_wrapper.gds"
gds read /tmp/tmpjktlz_pc/repo/gds/user_project_wrapper.gds
cd /tmp/tmpjktlz_pc/repo/precheck_results/13_MAY_2026___14_50_17/tmp/ext
...
foreach cell { UA_sky130_fd_sc_hd__fill_1
UA_sky130_fd_sc_hd__fill_2
UA_sky130_fd_sc_hd__tapvpwrvgnd_1 } { ;# Set abstract cells
	load $cell
