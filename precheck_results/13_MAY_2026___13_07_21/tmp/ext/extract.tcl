...
ucb_top } { ;# Load abstract cells
	if { [file exists /tmp/tmprp0gpsm7/repo/precheck_results/13_MAY_2026___13_07_21/tmp/ext/$cell.lef] } {
		puts "Using abstracted $cell"
		lef read /tmp/tmprp0gpsm7/repo/precheck_results/13_MAY_2026___13_07_21/tmp/ext/$cell.lef
	}
}
...
puts "\nExtracting /tmp/tmprp0gpsm7/repo/gds/user_project_wrapper.gds"
gds read /tmp/tmprp0gpsm7/repo/gds/user_project_wrapper.gds
cd /tmp/tmprp0gpsm7/repo/precheck_results/13_MAY_2026___13_07_21/tmp/ext
