...
UU_sky130_fd_sc_hd__tapvpwrvgnd_1 } { ;# Load abstract cells
	if { [file exists /tmp/tmpo285jwua/repo/precheck_results/12_MAY_2026___18_24_48/tmp/ext/$cell.lef] } {
		puts "Using abstracted $cell"
		lef read /tmp/tmpo285jwua/repo/precheck_results/12_MAY_2026___18_24_48/tmp/ext/$cell.lef
	}
}
...
puts "\nExtracting /tmp/tmpo285jwua/repo/gds/user_project_wrapper.gds"
gds read /tmp/tmpo285jwua/repo/gds/user_project_wrapper.gds
cd /tmp/tmpo285jwua/repo/precheck_results/12_MAY_2026___18_24_48/tmp/ext
