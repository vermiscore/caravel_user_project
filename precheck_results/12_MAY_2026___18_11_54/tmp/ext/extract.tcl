...
UU_sky130_fd_sc_hd__tapvpwrvgnd_1
ucb_top } { ;# Load abstract cells
	if { [file exists /tmp/tmpb8g2m4zu/repo/precheck_results/12_MAY_2026___18_11_54/tmp/ext/$cell.lef] } {
		puts "Using abstracted $cell"
		lef read /tmp/tmpb8g2m4zu/repo/precheck_results/12_MAY_2026___18_11_54/tmp/ext/$cell.lef
	}
}
...
puts "\nExtracting /tmp/tmpb8g2m4zu/repo/gds/user_project_wrapper.gds"
gds read /tmp/tmpb8g2m4zu/repo/gds/user_project_wrapper.gds
cd /tmp/tmpb8g2m4zu/repo/precheck_results/12_MAY_2026___18_11_54/tmp/ext
