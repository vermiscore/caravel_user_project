...
foreach cell { BV_sky130_fd_sc_hd__fill_1
...
BV_sky130_fd_sc_hd__tapvpwrvgnd_1 } { ;# Load abstract cells
	if { [file exists /tmp/tmpofaozfbi/repo/precheck_results/12_MAY_2026___08_39_22/tmp/ext/$cell.lef] } {
		puts "Using abstracted $cell"
		lef read /tmp/tmpofaozfbi/repo/precheck_results/12_MAY_2026___08_39_22/tmp/ext/$cell.lef
	}
}
...
puts "\nExtracting /tmp/tmpofaozfbi/repo/gds/user_project_wrapper.gds"
gds read /tmp/tmpofaozfbi/repo/gds/user_project_wrapper.gds
cd /tmp/tmpofaozfbi/repo/precheck_results/12_MAY_2026___08_39_22/tmp/ext
