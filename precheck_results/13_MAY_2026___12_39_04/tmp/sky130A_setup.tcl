...
if { [lsearch $cells1 {user_project_wrapper}] >= 0 } {
#puts stdout "Flattening user_project_wrapper in layout"
flatten class {-circuit1 user_project_wrapper}
}
if { [lsearch $cells2 {user_project_wrapper}] >= 0 } {
#puts stdout "Flattening user_project_wrapper in source"
flatten class {-circuit2 user_project_wrapper}
}
if { [lsearch $cells1 {sky130_fd_sc_hd__conb_1}] >= 0 } {
puts stdout {Ignoring sky130_fd_sc_hd__conb_1 in layout}
ignore class {-circuit1 sky130_fd_sc_hd__conb_1}
}
if { [lsearch $cells2 {sky130_fd_sc_hd__conb_1}] >= 0 } {
puts stdout {Ignoring sky130_fd_sc_hd__conb_1 in source}
ignore class {-circuit2 sky130_fd_sc_hd__conb_1}
}
