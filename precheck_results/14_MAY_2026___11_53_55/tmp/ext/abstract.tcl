...
puts "Abstracting /tmp/tmptvu9xxua/repo/gds/user_project_wrapper.gds"
...
UA_sky130_fd_sc_hd__tapvpwrvgnd_1 } { ;# Set abstract cells and delete all their subcell instances.
	load $cell
