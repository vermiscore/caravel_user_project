...
UA_sky130_fd_sc_hd__tapvpwrvgnd_1 } { ;# Load abstract cells
	if { [file exists /tmp/tmptvu9xxua/repo/precheck_results/14_MAY_2026___11_53_55/tmp/ext/$cell.lef] } {
		puts "Using abstracted $cell"
		lef read /tmp/tmptvu9xxua/repo/precheck_results/14_MAY_2026___11_53_55/tmp/ext/$cell.lef
	}
}
...
puts "\nExtracting /tmp/tmptvu9xxua/repo/gds/user_project_wrapper.gds"
gds read /tmp/tmptvu9xxua/repo/gds/user_project_wrapper.gds
cd /tmp/tmptvu9xxua/repo/precheck_results/14_MAY_2026___11_53_55/tmp/ext
