...
foreach cell {  } { ;# Load abstract cells
	if { [file exists /tmp/tmpkztbk_dw/repo/precheck_results/12_MAY_2026___12_40_46/tmp/ext/$cell.lef] } {
		puts "Using abstracted $cell"
		lef read /tmp/tmpkztbk_dw/repo/precheck_results/12_MAY_2026___12_40_46/tmp/ext/$cell.lef
	}
}
...
cd /tmp/tmpkztbk_dw/repo/precheck_results/12_MAY_2026___12_40_46/tmp/ext
