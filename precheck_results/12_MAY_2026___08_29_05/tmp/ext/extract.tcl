...
foreach cell { OC_sky130_fd_sc_hd__fill_1
OC_sky130_fd_sc_hd__fill_2
OC_sky130_fd_sc_hd__fill_4
OC_sky130_fd_sc_hd__fill_8
OC_sky130_fd_sc_hd__tapvpwrvgnd_1 } { ;# Load abstract cells
	if { [file exists /tmp/tmpto0p2d76/repo/precheck_results/12_MAY_2026___08_29_05/tmp/ext/$cell.lef] } {
		puts "Using abstracted $cell"
		lef read /tmp/tmpto0p2d76/repo/precheck_results/12_MAY_2026___08_29_05/tmp/ext/$cell.lef
	}
}
...
puts "\nExtracting /tmp/tmpto0p2d76/repo/gds/user_project_wrapper.gds"
gds read /tmp/tmpto0p2d76/repo/gds/user_project_wrapper.gds
cd /tmp/tmpto0p2d76/repo/precheck_results/12_MAY_2026___08_29_05/tmp/ext
...
OC_sky130_fd_sc_hd__fill_4
OC_sky130_fd_sc_hd__fill_8
OC_sky130_fd_sc_hd__tapvpwrvgnd_1 } { ;# Set abstract cells
	load $cell
