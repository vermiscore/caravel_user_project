...
puts "Abstracting /tmp/tmpto0p2d76/repo/gds/user_project_wrapper.gds"
...
OC_sky130_fd_sc_hd__tapvpwrvgnd_1 } { ;# Set abstract cells and delete all their subcell instances.
	load $cell
