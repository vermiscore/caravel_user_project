...
foreach cell { U6_sky130_fd_sc_hd__fill_1
U6_sky130_fd_sc_hd__fill_2
U6_sky130_fd_sc_hd__tapvpwrvgnd_1 } { ;# Load abstract cells
	if { [file exists /tmp/tmphsc7k81s/repo/precheck_results/14_MAY_2026___05_49_29/tmp/ext/$cell.lef] } {
		puts "Using abstracted $cell"
		lef read /tmp/tmphsc7k81s/repo/precheck_results/14_MAY_2026___05_49_29/tmp/ext/$cell.lef
	}
}
...
puts "\nExtracting /tmp/tmphsc7k81s/repo/gds/user_project_wrapper.gds"
gds read /tmp/tmphsc7k81s/repo/gds/user_project_wrapper.gds
cd /tmp/tmphsc7k81s/repo/precheck_results/14_MAY_2026___05_49_29/tmp/ext
...
foreach cell { U6_sky130_fd_sc_hd__fill_1
U6_sky130_fd_sc_hd__fill_2
U6_sky130_fd_sc_hd__tapvpwrvgnd_1 } { ;# Set abstract cells
	load $cell
