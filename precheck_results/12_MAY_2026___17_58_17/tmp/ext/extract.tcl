...
ucb_top } { ;# Load abstract cells
	if { [file exists /tmp/tmpsvb7moem/repo/precheck_results/12_MAY_2026___17_58_17/tmp/ext/$cell.lef] } {
		puts "Using abstracted $cell"
		lef read /tmp/tmpsvb7moem/repo/precheck_results/12_MAY_2026___17_58_17/tmp/ext/$cell.lef
	}
}
...
puts "\nExtracting /tmp/tmpsvb7moem/repo/gds/user_project_wrapper.gds"
gds read /tmp/tmpsvb7moem/repo/gds/user_project_wrapper.gds
cd /tmp/tmpsvb7moem/repo/precheck_results/12_MAY_2026___17_58_17/tmp/ext
