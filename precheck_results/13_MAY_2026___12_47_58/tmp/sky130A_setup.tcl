...
if { [lsearch $cells1 {ucb_top}] >= 0 } {
#puts stdout "Flattening ucb_top in layout"
flatten class {-circuit1 ucb_top}
}
if { [lsearch $cells2 {ucb_top}] >= 0 } {
#puts stdout "Flattening ucb_top in source"
flatten class {-circuit2 ucb_top}
}
