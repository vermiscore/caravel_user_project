...
puts "Abstracting /tmp/tmpjx6tsoga/repo/gds/user_project_wrapper.gds"
...
NH_sky130_fd_sc_hd__tapvpwrvgnd_1 } { ;# Set abstract cells and delete all their subcell instances.
	load $cell
