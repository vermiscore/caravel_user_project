...
foreach cell {  } { ;# Load abstract cells
	if { [file exists /tmp/tmpgjvo3b9m/repo/precheck_results/12_MAY_2026___11_48_47/tmp_oeb/ext/$cell.lef] } {
		puts "Using abstracted $cell"
		lef read /tmp/tmpgjvo3b9m/repo/precheck_results/12_MAY_2026___11_48_47/tmp_oeb/ext/$cell.lef
	}
}
...
puts "\nExtracting /tmp/tmpgjvo3b9m/repo/spi/lvs/user_project_wrapper.spice"
gds read /tmp/tmpgjvo3b9m/repo/spi/lvs/user_project_wrapper.spice
cd /tmp/tmpgjvo3b9m/repo/precheck_results/12_MAY_2026___11_48_47/tmp_oeb/ext
