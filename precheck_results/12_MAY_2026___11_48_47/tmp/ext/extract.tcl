...
foreach cell {  } { ;# Load abstract cells
	if { [file exists /tmp/tmpgjvo3b9m/repo/precheck_results/12_MAY_2026___11_48_47/tmp/ext/$cell.lef] } {
		puts "Using abstracted $cell"
		lef read /tmp/tmpgjvo3b9m/repo/precheck_results/12_MAY_2026___11_48_47/tmp/ext/$cell.lef
	}
}
...
cd /tmp/tmpgjvo3b9m/repo/precheck_results/12_MAY_2026___11_48_47/tmp/ext
