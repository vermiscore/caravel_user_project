...
U6_sky130_fd_sc_hd__tapvpwrvgnd_1 } { ;# Load abstract cells
	if { [file exists /tmp/tmpktxzdf_u/repo/precheck_results/13_MAY_2026___19_23_19/tmp/ext/$cell.lef] } {
		puts "Using abstracted $cell"
		lef read /tmp/tmpktxzdf_u/repo/precheck_results/13_MAY_2026___19_23_19/tmp/ext/$cell.lef
	}
}
...
puts "\nExtracting /tmp/tmpktxzdf_u/repo/gds/user_project_wrapper.gds"
gds read /tmp/tmpktxzdf_u/repo/gds/user_project_wrapper.gds
cd /tmp/tmpktxzdf_u/repo/precheck_results/13_MAY_2026___19_23_19/tmp/ext
